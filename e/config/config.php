...
$ecms_config['db']['dbusername']='s566472db0';	//数据库用户名
$ecms_config['db']['dbpassword']='123456';	//数据库密码
$ecms_config['db']['dbname']='s566472db0';	//数据库名
...
$ecms_config['esafe']['ecookiernd']='WhMvzRSb9bVHpG8w2RWm2x7kigRLES';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='mrape';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='dseex';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='5SXt2wTZLLv29gvZA3iszq66N7TdcK';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='aMXDJpMkhreALwK59ezaPCTM2ucfrM';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'6qXBuNBkELbjfx5RxpXgbmBrBqZmkg',
