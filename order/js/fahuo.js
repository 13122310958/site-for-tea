...
for(i=0;i<22;i++){
	...
	quotes=new Array
	quotes[1]='<p>订购的 产品：AAAAAAAAAA 已发货 邮政EMS <font color="#FF0000">√</font></p>'
	quotes[2]='<p>订购的 产品：BBBBBBBBBB 已发货 圆通速递 <font color="#FF0000">√</font></p>'
	...
	quotes[5]='<p>订购的 产品：AAAAAAAAAA 已发货 韵达快运 <font color="#FF0000">√</font></p>'
	quotes[6]='<p>订购的 产品：BBBBBBBBBB 已发货 顺风速运 <font color="#FF0000">√</font></p>'
	var quote=quotes[rand1]
	document.write(quote)
	document.write('<br>');
}
